...
from src.gev_fitting import gev_fit
...
dss_with_fit = [gev_fit(ds, var_name='t2m') for ds in dss]
dss_with_fit_on_both = [gev_fit(ds, var_name='t2m_anom') for ds in dss_with_fit]
