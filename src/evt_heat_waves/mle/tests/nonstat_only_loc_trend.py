...
def main():
    ...
    fitted_inds = np.array([0, 1, 2, 4], dtype=int)
    ...
    for i, n in enumerate(sample_sizes):
        ...
        est_params = _mle_fit(samples, fit_type='nonstat_only_loc_trend', SAMPLE_THRES=1)
        se = get_standard_errors(est_params, samples, fit_type='nonstat_only_loc_trend')
